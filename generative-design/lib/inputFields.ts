...
export const FORMAT_INPUT_FIELDS: Record<string, InputFieldDef[]> = {
  "Business Card": [
    ...
    },
    {
      ...
      style: "h4",
      defaultValue: "P:",
      position: { x: 0.06, y: 0.48, widthRatio: 0.5, heightRatio: 0.08, align: "left" },
    },
    {
      key: "phone",
      label: "Phone",
      ...
      style: "h3",
      color: "grey",
      position: { x: 0.15, y: 0.48, widthRatio: 0.5, heightRatio: 0.08, align: "left" },
    },
    {
      key: "e",
      label: "E",
      ...
      style: "h4",
      defaultValue: "E:",
      position: { x: 0.06, y: 0.54, widthRatio: 0.5, heightRatio: 0.08, align: "left" },
    },
    {
      key: "email",
      label: "Mail",
      ...
      style: "h3",
      color: "grey",
      position: { x: 0.15, y: 0.54, widthRatio: 0.5, heightRatio: 0.08, align: "left" },
    },
  ],
  Voucher: [
    {
